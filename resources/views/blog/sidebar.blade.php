...
{{--            <div style="display: inline-block; margin-left: -13px; width: 38%">--}}
        ...
        <aside class="widget">
            ...
            @foreach($popularPosts as $popularPost)
                <div class="popular-post">
                    <a href="{{ route('post.show', $popularPost->slug) }}" class="popular-img"><img src="{{ asset($popularPost->getImage()) }}" alt="">
            ...
            <div id="widget-feature" class="owl-carousel">
                @foreach($featuredPosts as $featuredPost)
                    ...
                    <div class="feature-content">
                        <img src="{{ asset($featuredPost->getImage()) }}" alt="">
            ...
            @foreach($recentPosts as $recentPost)
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="{{ route('post.show', $recentPost->slug) }}" class="popular-img"><img src="{{ asset($recentPost->getImage()) }}" alt="">
                            <div class="p-overlay"></div>
                        </a>
                    </div>
                    <div class="p-content">
